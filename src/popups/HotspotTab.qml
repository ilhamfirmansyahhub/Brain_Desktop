    ...
    Column {
        ...
        Item {
            ...
            Row {
                ...
                Text { anchors.verticalCenter: parent.verticalCenter; text: ShellState.hotspot ? "Active" : "Inactive"; font.pixelSize: 11; color: "#FFFFFF" }
            }
        }
                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        Rectangle {
                            ...
                            Text { anchors.centerIn: parent; text: "Save"; font.pixelSize: 12; font.weight: Font.Medium; color: "#FFFFFF" }
