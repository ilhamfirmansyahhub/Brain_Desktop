    ...
    component NetworkRow: Item {
        ...
        Item {
            ...
            Column {
                ...
                Text { visible: netRow.isCurrent; text: "Connected"; font.pixelSize: 10; color: "#FFFFFF" }
            }
            ...
            Row {
                ...
                Rectangle {
                    ...
                    Behavior on color { ColorAnimation { duration: 100 } }
                    Text { id: connectLbl; anchors.centerIn: parent; text: netRow.isExpanded ? "Retry" : "Connect"; font.pixelSize: 11; font.weight: Font.Medium; color: "#FFFFFF" }
        ...
        Column {
            ...
            Rectangle {
                ...
                Row { id: wfEnRow; anchors.centerIn: parent; spacing: 8
                    Text { anchors.verticalCenter: parent.verticalCenter; text: "󰤨"; font.pixelSize: 14; color: "#FFFFFF" }
